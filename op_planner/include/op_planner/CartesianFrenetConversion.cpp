// ***********************************************************************
#include "CartesianFrenetConversion.h"
#include <fstream>
namespace PlannerHNS
{
        ...
        double *const ptr_v, double *const ptr_a)
    {
        ...
        *ptr_theta = UtilityHNS::UtilityH::SplitPositiveAngle(delta_theta + rtheta);
    ...
    double CartesianFrenetConverter::CalculateTheta(const double rtheta,
                                                    ...
                                                    const double dl)
    {
        return UtilityHNS::UtilityH::SplitPositiveAngle(rtheta + std::atan2(dl, 1 - l * rkappa));
    }
