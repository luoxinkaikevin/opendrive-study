...
DEFINE_double(safe_time, 3.0,
              "The runtime duration in test mode. There is no runtime limit if "
              "the value is not positive");
DEFINE_double(forward_min_safe_distance, 20.0,
              "The runtime duration in test mode. There is no runtime limit if "
              "the value is not positive");              
DEFINE_double(backward_min_safe_distance, 2.0,
              "The runtime duration in test mode. There is no runtime limit if "
              "the value is not positive");

DEFINE_double(look_ahead_distance, 10,"find a reference point to set lane width and speed");

DEFINE_int32(max_global_planning_distance, 100000, "global planning max distance");
DEFINE_double(poi_max_perp_distance, 8.0,"global poi max perp distance to search");
DEFINE_double(goal_pose_epsilon, 0.3,"global poi max perp distance to search");
DEFINE_double(global_lane_change_min_distance, 25.0,"min distance to check lane change in global search");

DEFINE_double(change_lane_lat_bound, 1.3, "The bound of lateral offset");
DEFINE_double(ego_to_lane_boundary, 0.25, "The distance of ego to lane boundary");
...
DEFINE_double(
    stop_line_look_backward_distance, 0.1,
    "slow down when near stop line");
...
DEFINE_double(path_Density, 0.5,
...
DEFINE_double(trajectory_time_length, 5.0, "Trajectory time length");
...
DEFINE_double(speed_upper_bound, 13, "The highest speed allowed.");
...
DEFINE_double(lateral_acceleration_bound, 1.1,
...
DEFINE_double(kappa_bound, 0.30, "The bound for trajectory curvature");
...
DEFINE_double(st_max_t, 5, "the maximum t of st boundary");
...
DEFINE_double(decision_horizon, 150.0,
...
DEFINE_double(lon_collision_buffer, 8.0,
...
DEFINE_double(weight_lat_offset, 3.0, "Weight of lateral offset cost");
DEFINE_double(weight_lat_comfort, 2.0, "Weight of lateral comfort cost");
DEFINE_double(weight_centripetal_acceleration, 1.0,
...
DEFINE_double(weight_same_side_offset, 2.0,
...
DEFINE_double(weight_dist_travelled, 1.0, "Weight of travelled distance cost");
