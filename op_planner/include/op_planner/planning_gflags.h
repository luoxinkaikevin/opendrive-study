...
DECLARE_double(look_ahead_distance);
DECLARE_double(stop_line_look_backward_distance);
DECLARE_double(change_lane_lat_bound);
DECLARE_double(ego_to_lane_boundary);
DECLARE_double(safe_time);
DECLARE_double(forward_min_safe_distance);
DECLARE_double(backward_min_safe_distance);

DECLARE_int32(max_global_planning_distance);
DECLARE_double(poi_max_perp_distance);
DECLARE_double(goal_pose_epsilon);
DECLARE_double(global_lane_change_min_distance);
