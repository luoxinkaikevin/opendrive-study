#ifndef CARTESIANFRENETCONVERSION_H_
#define CARTESIANFRENETCONVERSION_H_
...
namespace PlannerHNS
{
   ...
   */
        ...
        // static GPSPoint CalculateCartesianPoint(const double rtheta, const GPSPoint &rpoint,
        //                                      const double l);
        /**
